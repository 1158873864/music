...
var firstID=0;
var theGroup=0;
$.get("assets/php/getquestiontype.php" ,async =false,function (data){
    var temp=data.split("\n");
...
function deletequestion(n){
    ...
    if(r) {
        var q = list[firstID + n];
        $.post("assets/php/deletequestiontype.php", {number: q[0]}, function (data) {
            alert("删除成功");
            window.location.href = "add_type_test.html";
        })
    }
}
function changetype(n) {
    var q=list[firstID+n];
    $.post("assets/php/deletequestiontype.php", {number:q[0]} ,function (data){
        window.location.href="changequestiontype.html";
    })
}
