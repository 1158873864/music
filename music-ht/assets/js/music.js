...
var firstID=0;
var theGroup=0;
$.get("assets/php/getmusic.php" ,async =false,function (data){
    var temp=data.split("\n");
...
function deletequestion(n){
    if(r) {
        var q = list[firstID + n];
        $.post("assets/php/deletemusic.php", {number: q[1]}, function (data) {
...
function changepage(page){
    ...
    if(list.length<(firstID+1)){
        ...
        document.getElementById("music"+(firstID%5+1)).src="../"+list[firstID][2];
        $("#your-alert-2").hide();
        $("#your-alert-3").hide();
        $("#your-alert-4").hide();
        $("#your-alert-5").hide();
        ...
        document.getElementById("music"+(firstID%5+2)).src="../"+list[firstID+1][2];
        $("#your-alert-3").hide();
        $("#your-alert-4").hide();
        $("#your-alert-5").hide();
    }
        ...
        document.getElementById("music"+(firstID%5+3)).src="../"+list[firstID+2][2];
        $("#your-alert-4").hide();
        $("#your-alert-5").hide();
    }
        ...
        document.getElementById("music"+(firstID%5+4)).src="../"+list[firstID+3][2];
        $("#your-alert-5").hide();
    }
    else{
        $("#your-alert-1").show();
        ...
        document.getElementById("music"+(firstID%5+5)).src="../"+list[firstID+4][2];
    }
...
function search(){
    ...
    for(var i=0;i<list.length;i++){
        if(list[i][0]==text){
            ...
            document.getElementById("music"+(firstID%5+1)).src="../"+list[i][2];
            $("#your-alert-2").hide();
            $("#your-alert-3").hide();
            $("#your-alert-4").hide();
            $("#your-alert-5").hide();
