...
var firstID=0;
var theGroup=0;
$.get("assets/php/getqResult.php" ,async =false,function (data){
    var temp=data.split("\n");
...
function setthisquestion(n){
    ...
    var thisquestion=q[0]+" "+q[1]+" "+q[2]+" "+q[3]+" "+q[4]+" "+q[5]+" "+q[6];
...
function deletequestion(n){
    ...
    if(r) {
        var q = list[firstID + n];
        $.post("assets/php/deleteqResult.php", {number: q[1]}, function (data) {
            alert("删除成功");
...
function changepage(page){
    ...
    if(list.length<(firstID+1)){
        ...
        $("#your-alert-1").show();
        document.getElementById("number"+(firstID%5+1)).innerText=list[firstID][0]+"-"+list[firstID][2];
        document.getElementById("name"+(firstID%5+1)).innerText=list[firstID][1];
        document.getElementById("date"+(firstID%5+1)).innerText=list[firstID][6];
        $("#your-alert-2").hide();
        $("#your-alert-3").hide();
        $("#your-alert-4").hide();
        $("#your-alert-5").hide();
        ...
        document.getElementById("name"+(firstID%5+1)).innerText=list[firstID][1];
        document.getElementById("date"+(firstID%5+1)).innerText=list[firstID][6];
        document.getElementById("number"+(firstID%5+2)).innerText=list[firstID+1][0]+"-"+list[firstID+1][2];
        document.getElementById("name"+(firstID%5+2)).innerText=list[firstID+1][1];
        document.getElementById("date"+(firstID%5+2)).innerText=list[firstID+1][6];
        $("#your-alert-3").hide();
        $("#your-alert-4").hide();
        $("#your-alert-5").hide();
    }
        ...
        document.getElementById("name"+(firstID%5+2)).innerText=list[firstID+1][1];
        document.getElementById("date"+(firstID%5+2)).innerText=list[firstID+1][6];
        document.getElementById("number"+(firstID%5+3)).innerText=list[firstID+2][0]+"-"+list[firstID+2][2];
        document.getElementById("name"+(firstID%5+3)).innerText=list[firstID+2][1];
        document.getElementById("date"+(firstID%5+3)).innerText=list[firstID+2][6];
        $("#your-alert-4").hide();
        $("#your-alert-5").hide();
    }
        ...
        document.getElementById("name"+(firstID%5+3)).innerText=list[firstID+2][1];
        document.getElementById("date"+(firstID%5+3)).innerText=list[firstID+2][6];
        document.getElementById("number"+(firstID%5+4)).innerText=list[firstID+3][0]+"-"+list[firstID+3][2];
        document.getElementById("name"+(firstID%5+4)).innerText=list[firstID+3][1];
        document.getElementById("date"+(firstID%5+4)).innerText=list[firstID+3][6];
        $("#your-alert-5").hide();
    }
    else{
        $("#your-alert-1").show();
        ...
        document.getElementById("name"+(firstID%5+4)).innerText=list[firstID+3][1];
        document.getElementById("date"+(firstID%5+4)).innerText=list[firstID+3][6];
        document.getElementById("number"+(firstID%5+5)).innerText=list[firstID+4][0]+"-"+list[firstID+4][2];
        document.getElementById("name"+(firstID%5+5)).innerText=list[firstID+4][1];
        document.getElementById("date"+(firstID%5+5)).innerText=list[firstID+4][6];
    }
...
function search(){
    ...
    for(var i=0;i<list.length;i++){
        if(list[i][1]==text){
            $("#your-alert-1").show();
            document.getElementById("number"+(firstID%5+1)).innerText=list[i][0]+"-"+list[i][2];
            document.getElementById("name"+(firstID%5+1)).innerText=list[i][1];
            document.getElementById("date"+(firstID%5+1)).innerText=list[i][6];
            $("#your-alert-2").hide();
            $("#your-alert-3").hide();
            $("#your-alert-4").hide();
            $("#your-alert-5").hide();
