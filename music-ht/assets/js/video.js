...
var firstID=0;
var theGroup=0;
$.get("assets/php/getvideo.php" ,async =false,function (data){
    var temp=data.split("\n");
...
function deletequestion(n){
    ...
    if(r) {
        var q = list[firstID + n];
        $.post("assets/php/deletevideo.php", {number: q[1]}, function (data) {
...
function changepage(page){
    ...
    if(list.length<(firstID+1)){
        ...
        document.getElementById("date"+(firstID%5+1)).innerText=list[firstID][7];
        $("#your-alert-2").hide();
        $("#your-alert-3").hide();
        $("#your-alert-4").hide();
        $("#your-alert-5").hide();
        ...
        document.getElementById("date"+(firstID%5+2)).innerText=list[firstID+1][7];
        $("#your-alert-3").hide();
        $("#your-alert-4").hide();
        $("#your-alert-5").hide();
    }
        ...
        document.getElementById("date"+(firstID%5+3)).innerText=list[firstID+2][7];
        $("#your-alert-4").hide();
        $("#your-alert-5").hide();
    }
        ...
        document.getElementById("date"+(firstID%5+4)).innerText=list[firstID+3][7];
        $("#your-alert-5").hide();
    }
    else{
        $("#your-alert-1").show();
        ...
        document.getElementById("date"+(firstID%5+5)).innerText=list[firstID+4][7];
    }
...
function search(){
    ...
    for(var i=0;i<list.length;i++){
        if(list[i][0]==text){
            ...
            document.getElementById("date"+(firstID%5+1)).innerText=list[i][7];
            $("#your-alert-2").hide();
            $("#your-alert-3").hide();
            $("#your-alert-4").hide();
            $("#your-alert-5").hide();
