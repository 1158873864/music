...
var firstID=0;
var theGroup=0;
$.get("assets/php/getarticletype.php" ,async =false,function (data){
    var temp=data.split("\n");
...
function deletequestion(n){
    ...
    if(r) {
        var q = list[firstID + n];
        $.post("assets/php/deletearticletype.php", {number: q[0]}, function (data) {
            alert("删除成功");
            window.location.href = "add_type_article.html";
        })
    }
}
function changetype(n) {
    var q=list[firstID+n];
    $.post("assets/php/deletearticletype.php", {number:q[0]} ,function (data){
        window.location.href="changearticletype.html";
    })
}
...
function changepage(page){
    ...
    if(list.length<(firstID+1)){
        ...
        document.getElementById("date"+(firstID%5+1)).src="../"+list[firstID][2];
        $("#your-alert-2").hide();
        $("#your-alert-3").hide();
        $("#your-alert-4").hide();
        $("#your-alert-5").hide();
        ...
        document.getElementById("date"+(firstID%5+2)).src="../"+list[firstID+1][2];
        $("#your-alert-3").hide();
        $("#your-alert-4").hide();
        $("#your-alert-5").hide();
    }
        ...
        document.getElementById("date"+(firstID%5+3)).src="../"+list[firstID+2][2];
        $("#your-alert-4").hide();
        $("#your-alert-5").hide();
    }
        ...
        document.getElementById("date"+(firstID%5+4)).src="../"+list[firstID+3][2];
        $("#your-alert-5").hide();
    }
    else{
        $("#your-alert-1").show();
        ...
        document.getElementById("date"+(firstID%5+5)).src="../"+list[firstID+4][2];
    }
...
function deletesingle(n){
    var q=list[firstID+n];
    $.post("assets/php/deletequestion.php", {number:q[0]} ,function (data){
    })
}
function delAll(){
    var r=confirm("确认删除么？");
...
function search(){
    ...
    for(var i=0;i<list.length;i++){
        if(list[i][1]==text){
            ...
            document.getElementById("date"+(firstID%5+1)).src="../"+list[i][2];
            $("#your-alert-2").hide();
            $("#your-alert-3").hide();
            $("#your-alert-4").hide();
            $("#your-alert-5").hide();
