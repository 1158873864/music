...
var firstID=0;
var theGroup=0;
$.get("php/getgame.php" ,function (data){
    var temp=data.split("\n");
...
function changepage(page){
    ...
    if(list.length<(firstID+1)){
        ...
        document.getElementById("date"+(firstID%5+1)).src="../"+list[firstID][6];
        $("#your-alert-2").hide();
        $("#your-alert-3").hide();
        $("#your-alert-4").hide();
        $("#your-alert-5").hide();
        ...
        document.getElementById("date"+(firstID%5+2)).src="../"+list[firstID+1][6];
        $("#your-alert-3").hide();
        $("#your-alert-4").hide();
        $("#your-alert-5").hide();
    }
        ...
        document.getElementById("date"+(firstID%5+3)).src="../"+list[firstID+2][6];
        $("#your-alert-4").hide();
        $("#your-alert-5").hide();
    }
        ...
        document.getElementById("date"+(firstID%5+4)).src="../"+list[firstID+3][6];
        $("#your-alert-5").hide();
    }
    else{
        $("#your-alert-1").show();
        ...
        document.getElementById("date"+(firstID%5+5)).src="../"+list[firstID+4][6];
    }
