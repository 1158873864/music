...
var firstID=0;
var theGroup=0;
$.get("assets/php/getgame.php" ,async =false,function (data){
    var temp=data.split("\n");
...
function setthisquestion(n){
    ...
    var thisquestion=q[0]+"???"+q[1]+"???"+q[2]+"???"+q[3]+"???"+q[4]+"???"+q[5];
...
function deletequestion(n){
    ...
    if(r) {
        var q = list[firstID + n];
        $.post("assets/php/deletegame.php", {number: q[1]}, function (data) {
...
function changepage(page){
    ...
    if(list.length<(firstID+1)){
        ...
        document.getElementById("size"+(firstID%5+1)).innerText=list[firstID][3];
        document.getElementById("pressure"+(firstID%5+1)).innerText=list[firstID][4];
        document.getElementById("date"+(firstID%5+1)).innerText=list[firstID][5];
        $("#your-alert-2").hide();
        $("#your-alert-3").hide();
        $("#your-alert-4").hide();
        $("#your-alert-5").hide();
        ...
        document.getElementById("size"+(firstID%5+2)).innerText=list[firstID+1][3];
        document.getElementById("pressure"+(firstID%5+2)).innerText=list[firstID+1][4];
        document.getElementById("date"+(firstID%5+2)).innerText=list[firstID+1][5];
        $("#your-alert-3").hide();
        $("#your-alert-4").hide();
        $("#your-alert-5").hide();
    }
        ...
        document.getElementById("size"+(firstID%5+3)).innerText=list[firstID+2][3];
        document.getElementById("pressure"+(firstID%5+3)).innerText=list[firstID+2][4];
        document.getElementById("date"+(firstID%5+3)).innerText=list[firstID+2][5];
        $("#your-alert-4").hide();
        $("#your-alert-5").hide();
    }
        ...
        document.getElementById("size"+(firstID%5+4)).innerText=list[firstID+3][3];
        document.getElementById("pressure"+(firstID%5+4)).innerText=list[firstID+3][4];
        document.getElementById("date"+(firstID%5+4)).innerText=list[firstID+3][5];
        $("#your-alert-5").hide();
    }
    else{
        $("#your-alert-1").show();
        ...
        document.getElementById("size"+(firstID%5+5)).innerText=list[firstID+4][3];
        document.getElementById("pressure"+(firstID%5+5)).innerText=list[firstID+4][4];
        document.getElementById("date"+(firstID%5+5)).innerText=list[firstID+4][5];
    }
...
function search(){
    ...
    for(var i=0;i<list.length;i++){
        if(list[i][0]==text){
            ...
            document.getElementById("size"+(firstID%5+1)).innerText=list[i][3];
            document.getElementById("pressure"+(firstID%5+1)).innerText=list[i][4];
            document.getElementById("date"+(firstID%5+1)).innerText=list[i][5];
            $("#your-alert-2").hide();
            $("#your-alert-3").hide();
            $("#your-alert-4").hide();
            $("#your-alert-5").hide();
