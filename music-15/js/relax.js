...
var firstID=0;
var theGroup=0;
$.get("php/getvideo.php" ,function (data){
    var temp=data.split("\n");
...
function setthisquestion(n){
    ...
    var thisquestion=q[0]+"???"+q[1]+"???"+q[2]+"???"+q[3]+"???"+q[4]+"???"+q[5]+"???"+q[6]+"???"+q[7]+"???"+q[8]+"???"+q[9];
    $.post("php/setthisvideo.php" ,{thisquestion:thisquestion},function (data){
...
function changepage(page){
    ...
    if(list.length<(firstID+1)){
        ...
        document.getElementById("image"+(firstID%8+1)).src="../"+list[firstID][8];
        $("#your-alert-2").hide();
        $("#your-alert-3").hide();
        $("#your-alert-4").hide();
        $("#your-alert-5").hide();
        ...
        document.getElementById("image"+(firstID%8+2)).src="../"+list[firstID+1][8];
        $("#your-alert-3").hide();
        $("#your-alert-4").hide();
        $("#your-alert-5").hide();
        $("#your-alert-6").hide();
        ...
        document.getElementById("image"+(firstID%8+3)).src="../"+list[firstID+2][8];
        $("#your-alert-4").hide();
        $("#your-alert-5").hide();
        $("#your-alert-6").hide();
        $("#your-alert-7").hide();
        ...
        document.getElementById("image"+(firstID%8+4)).src="../"+list[firstID+3][8];
        $("#your-alert-5").hide();
        $("#your-alert-6").hide();
        $("#your-alert-7").hide();
        $("#your-alert-8").hide();
        ...
        document.getElementById("image"+(firstID%8+5)).src="../"+list[firstID+4][8];
        $("#your-alert-6").hide();
        $("#your-alert-7").hide();
        $("#your-alert-8").hide();
    }
        ...
        document.getElementById("image"+(firstID%8+6)).src="../"+list[firstID+5][8];
        $("#your-alert-7").hide();
        $("#your-alert-8").hide();
    }
        ...
        document.getElementById("image"+(firstID%8+7)).src="../"+list[firstID+6][8];
        $("#your-alert-8").hide();
    }
    else{
        $("#your-alert-1").show();
        ...
        document.getElementById("image"+(firstID%8+8)).src="../"+list[firstID+7][8];
    }
